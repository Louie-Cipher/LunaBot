...
module.exports = {
  ...
  async execute(client, message, args) {
    ...
    if(!valor || valor < 1) return message.channel.send({embed: {color: '#f0f000', title: 'informe um valor para depositar no banco', description: 'o valor precisa ser um número inteiro (sem virgula) e positivo'}});
